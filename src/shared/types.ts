/**
 * The domain vocabulary: what a session, repo, roundtable, PR or update *is*.
 *
 * This module is a leaf on purpose — it imports nothing from the rest of src/, so
 * every layer can depend on it and none of it can depend back. The IPC contract
