...
export function ProviderLogo({ p, size = 14 }: { p: Provider; size?: number }): JSX.Element {
  if (p === 'claude') {
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" className="logo-claude" aria-label="Claude">
  ...
  if (p === 'codex') {
    return (
      <svg width={size} height={size} viewBox="0 0 2406 2406" className="logo-codex" aria-label="Codex">
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className="logo-copilot" aria-label="Copilot">
