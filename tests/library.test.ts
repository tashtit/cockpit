    ...
    const r = instructionRow(
      {
        ...
        baseline: 'be careful',
        files: [
          { agents: ['claude'], path: '/h/.claude/CLAUDE.md', exists: true, content: '', block: null, own: { above: 0, below: 0 }, status: 'synced' },
          { agents: ['codex'], path: '/h/.codex/AGENTS.md', exists: true, content: '', block: null, own: { above: 0, below: 0 }, status: 'drifted' },
          { agents: ['copilot'], path: '/h/.copilot/i.md', exists: false, content: '', block: null, own: { above: 0, below: 0 }, status: 'missing' }
        ]
      },
      entry
    )
    ...
    const r = instructionRow(
      {
        ...
        baseline: 'x',
        files: [
          { agents: ['claude'], path: '/repo/CLAUDE.md', exists: true, content: '', block: null, own: { above: 0, below: 0 }, status: 'synced' },
          { agents: ['codex', 'copilot'], path: '/repo/AGENTS.md', exists: true, content: '', block: null, own: { above: 0, below: 0 }, status: 'synced' }
        ]
      },
      entry
    )
