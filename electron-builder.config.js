...
module.exports = {
  ...
  // `npm run build` (scripts/licenses); Chromium's come with Electron, and electron-builder
  // deletes Electron's own copies from a mac bundle — without these lines they never ship.
  extraResources: [
